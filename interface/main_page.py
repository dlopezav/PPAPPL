...
class main_page(ttk.Frame):
    def __init__(self, frameprincipal):
        ...
        self.frames_notebook = [Notebook_propeller(self.notebook),Notebook_fluelflow(self.notebook)]

        self.notebook.add(self.frames_notebook[0],text="propeller")
        self.notebook.add(self.frames_notebook[1],text="fluelflow")
...
class Notebook_fluelflow(ttk.Frame):
    def __init__(self, tab_notebook):
        super().__init__(tab_notebook, style='cyborg')
