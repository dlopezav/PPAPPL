...
if MP.pages[0].begin:
    ...
    class Run_program:
        ...
        #Prop = Propeller_sys(name='Prop')
        EngineRot = Rotationspeed(name='EngineRot')
        PowerMag = Powermanagement(name='PowerMag')
        ...
        PAE2_max,PAE2_min,nu1AE2,nu2AE2,nuelAE2) = MP.pages[0].values
